...
struct psa
{
  ...
  void *__ptr32 _filler28;    /* -         MODEL PSW SECOND HALF  (MDC325)  @G50DP9A    */
  unsigned char psasmpsw[4];  /* - SRB DISPATCH PSW  (MDC326)      @G50DP9A             */
  void *__ptr32 _filler29;    /* -         DISPATCH PSW SECOND HALF                     */
  ...
  union
  {
    ...
    struct
    {
      double _filler30;           /* -           Part of PSAPSWSV16                   @M8C */
  ...
  struct
  {
    unsigned char _filler31; /* -      RESERVED - FIRST BYTE OF PSAMODEW         */
  ...
  unsigned char _filler32[3]; /* -      RESERVED                         @G860PXK       */
  ...
  struct
  {
    ...
    int _filler33; /* -         FULLWORD OF ZERO     (MDC612)    @G383P9A */
  } psadzero;
...
#define psaus2st _psa_union31._psa_struct23._psaus2st
...
#define psaus2nd _psa_union35._psa_struct24._psaus2nd
...
#define psarvb80 _psa_union36._psarvb80
#define psastak _psa_union36._psastak
