...
struct ascb {
  ...
  struct {
    ...
    unsigned char  _ascbr122[2]; /* -               RESERVED.                       @P5C   */
    } ascbfw3;
  ...
  unsigned char  ascbr168[2];  /* -              RESERVED.                       @0AC    */
...
#define ascbsvrb___prezos12 ascbr010.ascbsupc___prezos12._ascbsvrb___prezos12
#define ascbsync___prezos12 ascbr010.ascbsupc___prezos12._ascbsync___prezos12
